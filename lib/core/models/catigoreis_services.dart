...
CategoriesServicesModel categoriesServicesModelFromJson(String str) =>
    CategoriesServicesModel.fromJson(json.decode(str));

String categoriesServicesModelToJson(CategoriesServicesModel data) =>
...
class CategoriesServicesModel {
  ...
  factory CategoriesServicesModel.fromJson(Map<String, dynamic> json) =>
      CategoriesServicesModel(
        data: json["data"] == null
            ? []
