    ...
    return BlocConsumer<AddServiceCubit, AddServiceState>(
      ...
      builder: (context, state) {
        ...
        return BlocBuilder<PostsCubit, PostsState>(
          builder: (context, state) {
            PostsCubit cubit2 = context.read<PostsCubit>();
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10),
                      //! sub Cities
                      cubit2.subCategoriesAtAddProduct.isEmpty
                          ? Container()
                          : Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Padding(
                                  ...
                                  child: Text("activity_type2".tr()),
                                ),
                                SizedBox(
                                  width: size.width * 0.68,
                                  child: CategoryDropDownSubCategory(
                                    hint: 'activity_type'.tr(),
                                    dropdownValue: cubit2.currentSubCategory,
                                    items: cubit2.subCategoriesAtAddProduct,
                                    onChanged:
                                        (SubCategoryModeel? newValue) async {
                                      cubit2.changeCategoryName(newValue);
                                    },
                                  ),
                                )
                              ],
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: cubit.serviceImages.length >= 1
                                  ? ListView.builder(
                                      shrinkWrap: true,
                      ...
                      Padding(
                          ...
                          child: CustomButton(
                              ...
                              onClick: () async {
                                ...
                                if (cubit2
                                    .subCategoriesAtAddProduct.isNotEmpty) {
                                  if (cubit2.currentSubCategory == null) {
                                    print("cubit.currentCategory == null");
                                    Fluttertoast.showToast(
                                      //msg: "logo_validate".tr(),
                                      msg: "اختر نوع النشاط",
                                ...
                                if (formKey.currentState!.validate() &&
                                    ...
                                    cubit.currentCategory != null &&
                                    cubit.currentCity != null &&
                                    cubit.isOpened == true) {
                                  print(
                                  ...
                                  if (cubit.isUpdate) {
                                    ...
                                    cubit.serviceModel = ServiceModel(
                                        longitude:
                                            cubit.selectedLocation.longitude,
                                        latitude:
                                            cubit.selectedLocation.latitude,
                                        cityId: cubit.currentCity?.id ?? 12,
                                        city: cubit.currentCity?.name,
                                        name: cubit.nameController.text,
                                        category_id: cubit.currentCategory!.id
                                            .toString(),
                                        details: cubit.detailsController.text,
                                        logo: cubit.serviceLogoImage!,
                                        location: cubit.locationController.text,
                                        images: cubit.serviceImages,
                                        sub_category_id: cubit2
                                    ...
                                    await cubit.storeService(context);
                                  }
