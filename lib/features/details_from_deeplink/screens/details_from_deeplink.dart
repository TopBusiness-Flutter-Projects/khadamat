    ...
    return WillPopScope(
      ...
      BlocConsumer<DetailsDeeplinkCubit, DetailsDeeplinkState>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            body: widget.id == 0 && cubit.serviceDetails==null?
                            ...
                            child: CircleAvatar(
                                ...
                                child: ClipOval(
                                  child: ManageNetworkImage(
                                    imageUrl: cubit.serviceDetails!.data!.logo!,
                                    width: 116,
                                    height: 116,
                                  ),
                                )),
                      ...
                      //  Text(cubit.serviceDetails!.data!.categoryId ?? " "),
                        SizedBox(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FutureBuilder(
                                future: cubit.getAddressFromLatLng(double.parse(cubit.serviceDetails!.data!.latitude??"30.0459"), double.parse(cubit.serviceDetails!.data!.latitude??"31.2243")),
                        ...
                        Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () async {
                                await _showDialog(context, cubit.serviceDetails!.data!.phones![0],
                                    cubit.serviceDetails!.data!.phones![1]);
                              },
                              child: Column(
                                children: [
                                  CircleAvatar(
                            ...
                            InkWell(
                              onTap: () async {
                                await cubit.addToFavourite(cubit.serviceDetails!.data!.id);
                              },
                              child: Column(
                                children: [
                                  CircleAvatar(
                            ...
                            InkWell(
                              onTap: () async {
                                cubit.shareApplication(cubit.serviceDetails!.data!.id);
                                // await Share.share(
                            ...
                            InkWell(
                              onTap: () {
                                ...
                                Navigator.pushNamed(context, Routes.googleMapDetailsRoute,arguments: LatLng(double.parse(cubit.serviceDetails!.data!.latitude!), double.parse(cubit.serviceDetails!.data!.longitude!)
                                ));
                              },
                              child: Column(
                                children: [
                            ...
                            children: [
                                ...
                                children: [
                                  Text(
                                   ...
                                   //todo=> return this value from api
                                    cubit.serviceDetails!.data!.reviews.toString() ?? "10",
                                    style: TextStyle(
                              ...
                              Column(
                                children: [
                                  Text(
                                    //todo=> return this value from api
                                   // "20",
                                   cubit.serviceDetails!.data!.followers.toString() ?? "10",
                                    style: TextStyle(
                                        fontWeight: FontWeight.w600,
                                        fontSize: 20,
                                        color: Colors.blueAccent),
                              ...
                              Column(
                                children: [
                                  Text(
                                   // "30",
                                    cubit.serviceDetails!.data!.following.toString(),
                                    style: TextStyle(
                                        fontWeight: FontWeight.w600,
                                        fontSize: 20,
                                        color: Colors.blueAccent),
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: cubit.serviceDetails!.data!.images?.length,
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: () {
                                  //TODO
                                  Navigator.pushNamed(context, Routes.fullScreenImageRoute,
                                      arguments: cubit.serviceDetails!.data!.images![index]);
                                },
                                child: Padding(
                                  ...
                                  child: ManageNetworkImage(
                                    width: 100,
                                    borderRadius: 10,
                                    imageUrl: cubit.serviceDetails!.data!.images!.isNotEmpty
                                        ? cubit.serviceDetails!.data!.images![index]
                                ...
                                return AlertDialog(
                                  ...
                                  actions: <Widget>[
                                    ...
                                    TextButton(
                                      child: Text('rate'.tr()),
                                      onPressed: () async {
                                        await cubit.setRate(cubit.serviceDetails!.data!.id);
                                        Navigator.of(context).pop();
                                      },
                                    ),
                                  ],
                ...
                Positioned(
                    ...
                    child: ClipPath(
                      ...
                      child: Container(
                        ...
                        child: cubit.serviceDetails!.data!.images!.isNotEmpty
                            ? ManageNetworkImage(
                          imageUrl: cubit.serviceDetails!.data!.images![0],
                        )
                            : Image.asset(
